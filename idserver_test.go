...
func TestGenerateIdTokensByUsername(t *testing.T) {
	var at = AuthToken{}
	r := new(http.Request)
	token, refresh, idtoken, err := _sut.generateIdTokens("RS256", at.Aud, UserToken, "user111", "", []string{"group1"}, at, r)
